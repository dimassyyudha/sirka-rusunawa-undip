<footer class="bg-[#070b55] text-white">
    <div class="mx-auto max-w-[1500px] px-4 py-12">
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-4 xl:gap-12">
            ...
            <div class="text-center md:text-left">
                <h3 class="text-3xl font-black tracking-wide">SIRKA</h3>

                <p class="mx-auto mt-3 max-w-xs text-sm leading-relaxed text-white/85 md:mx-0">
                    Sistem Informasi Reservasi Kamar Rusunawa Universitas Diponegoro.
                </p>

                <div class="mt-7 flex flex-wrap items-center justify-center gap-4 md:justify-start">
                    <img src="{{ asset('images/logo/logo-undip-01.png') }}" class="h-12 w-auto object-contain">
                    <img src="{{ asset('images/logo/logo-undip.png') }}" class="h-14 w-auto object-contain">
                    <img src="{{ asset('images/logo/logo-bpubikar-1.png') }}" class="h-12 w-auto object-contain">
                </div>
            </div>

            {{-- MENU --}}
            <div class="text-center md:text-left">
                <h4 class="text-lg font-black">Menu</h4>

                <ul class="mt-5 space-y-3 text-sm font-semibold text-white/90">
                    <li>
            ...
            {{-- INFORMASI --}}
            <div class="text-center md:text-left">
                <h4 class="text-lg font-black">Informasi</h4>

                <ul class="mx-auto mt-5 max-w-xs space-y-3 text-sm font-semibold leading-relaxed text-white/90 md:mx-0">
                    <li>Rusunawa UNDIP</li>
                    <li>
                        Gedung A Lantai 1<br>
                        Jl. Prof. Soedarto, Bulusan, Tembalang, Semarang, Jawa Tengah 50277
                    </li>
                    <li>Senin - Jumat</li>
                    <li>08.00 - 16.00 WIB</li>
                </ul>
                <div class="mt-8">
                    <h4 class="text-lg font-black mb-5">Ikuti Kami</h4>
                    ...
                    <div class="flex items-center justify-center lg:justify-start gap-4 flex-wrap">
                        ...
                        <div class="relative inline-block group">
                            ...
                            <a href="https://wa.me/6281128510073" target="_blank"
                                class="w-11 h-11 flex items-center justify-center bg-white rounded-xl shadow-md hover:-translate-y-1 transition">

                                <svg class="transition-all duration-300 hover:scale-110"
                            ...
                            <div
                                class="absolute top-full invisible left-1/2 z-20 mt-3 border border-gray-300 -translate-x-1/2 whitespace-nowrap rounded-md bg-white py-2 px-4 text-xs text-gray-800 font-medium opacity-0 transition-all duration-300 group-hover:visible group-hover:opacity-100">

                                <span
                                    class="absolute -top-1.5 left-1/2 -z-10 h-3 w-3 border-t border-l rounded-sm border-gray-300 -translate-x-1/2 rotate-45 bg-white">
                                </span>
                        ...
                        <div class="relative inline-block group">
                            ...
                            <a href="mailto:rusunundip@gmail.com" target="_blank"
                                class="w-11 h-11 flex items-center justify-center bg-white rounded-xl shadow-md hover:-translate-y-1 transition">

                                <svg class="rounded-md transition-all duration-300 hover:scale-110" width="28"
                        ...
                        <div class="relative inline-block group">
                            ...
                            <a href="https://www.instagram.com/rusunawa.undip/" target="_blank"
                                class="w-11 h-11 flex items-center justify-center bg-white rounded-xl shadow-md hover:-translate-y-1 transition">

                                <svg class="transition-all duration-300 hover:scale-110" width="28" height="28"
                        ...
                        <div class="relative inline-block group">
                            ...
                            <a href="https://www.tiktok.com/@rusunawa.undip" target="_blank"
                                class="w-11 h-11 flex items-center justify-center bg-white rounded-xl shadow-md hover:-translate-y-1 transition">

                                <svg class="transition-all duration-300 hover:scale-110" width="28"
                                    height="28" viewBox="0 0 72 72" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="text-center lg:text-left">
                <h4 class="text-lg font-black mb-6">Lokasi Kami</h4>

                <div class="rounded-2xl overflow-hidden shadow-lg border border-white/10">
                    <iframe src="https://maps.google.com/maps?q=rusunawa%20undip&t=&z=15&ie=UTF8&iwloc=&output=embed"
    ...
    <div class="border-t border-white/10 px-4 py-5 text-center text-sm text-white/70">
        Copyright © {{ date('Y') }} SIRKA UNDIP All rights reserved
    </div>
</footer>
