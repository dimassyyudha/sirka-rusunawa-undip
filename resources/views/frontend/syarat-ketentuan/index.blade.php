...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-12 h-1 w-full overflow-hidden rounded-full bg-slate-100">
        <div id="reading-progress"
            class="h-full w-0 rounded-full bg-indigo-600 transition-all duration-150">
        </div>
    </div>
    ...
    <div class="mt-16 grid gap-16 lg:grid-cols-[280px_1fr]">
        ...
        <aside class="hidden lg:block">
            ...
            <div class="sticky top-28">
                ...
                <h3
                    class="mb-5 text-xs font-bold uppercase tracking-[0.2em] text-slate-500">
        ...
        <div>
            ...
            @foreach ($syaratKetentuan['sections'] ?? [] as $index => $section)
                ...
                <section id="section-{{ $index }}"
                    class="content-section scroll-mt-32 pb-16">

                    <div
                        class="mb-8 flex items-center gap-4 border-b border-slate-200 pb-5">
                    ...
                    @if (!empty($section['items']))
                        ...
                        <div class="space-y-5">
                            ...
                            @foreach ($section['items'] as $item)
                                ...
                                <div
                                    class="flex gap-4 rounded-xl p-4 transition hover:bg-slate-50">
