...
@section('title', 'Edit Rekomendasi Kamar')
@section('page_title', 'Edit Rekomendasi Kamar')
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
                ...
                <h1 class="text-3xl font-black text-slate-900">
                    Edit Rekomendasi Kamar
                </h1>

                <p class="mt-2 text-slate-500">
                    Perbarui data rekomendasi kamar yang ditampilkan pada halaman beranda.
                </p>
