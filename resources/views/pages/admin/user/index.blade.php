                    ...
                    <div class="d-flex align-items-center">
                        <form action="{{ route('admin.user.index') }}" method="GET" class="d-flex gap-2">
                            ...
                            <select name="role" class="form-select" onchange="this.form.submit()" style="width: 200px;">
                                ...
                                <option value="staff" {{ request('role') == 'staff' ? 'selected' : '' }}>Staff Inventaris
                                </option>
                                <option value="kades" {{ request('role') == 'kades' ? 'selected' : '' }}>Kepala Desa
                                </option>
                            </select>

                            {{-- Tombol Reset (Muncul hanya jika sedang memfilter) --}}
                            @if (request('role'))
                                <a href="{{ route('admin.user.index') }}" class="btn btn-secondary" title="Reset Filter">
